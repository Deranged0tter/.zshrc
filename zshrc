...
alias ll='ls -l'
alias la='ls -A'
alias l='ls -lA' # changed to my go to
alias lr='ls -lAR' # recursive
...
# Additions to prompt
RPROMPT='[ %F{blue}%D{%m/%f/%y} %F{white}| %F{blue}%D{%H:%M:%S} %F{white}] '$RPROMPT
TMOUT=1
...
alias :q='exit'
alias q='exit'
alias gps='ps aux | head -n 1; ps aux | grep'
alias ipa='ip a'
